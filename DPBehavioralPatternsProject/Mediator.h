...
protected:
	...
	ColleagueType type;
public:
	Colleague(Mediator* mediator, ColleagueType type) : mediator{ mediator }, type{ type } {}
...
{
public:
	CustomerColleague(Mediator* mediator) : Colleague(mediator, ColleagueType::Customer) {}
...
{
public:
	DeveloperColleague(Mediator* mediator) : Colleague(mediator, ColleagueType::Developer) {}
	void Notify(string message) override
	{
...
{
public:
	TesterColleague(Mediator* mediator) : Colleague(mediator, ColleagueType::Tester) {}
	void Notify(string message) override
	{
